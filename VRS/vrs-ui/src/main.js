...
const i18n = new VueI18n({
  ...
  messages: {
    en: {
      ...
      jjk: 'Pass', jjk1: 'No pass', jjk2: 'The current time is:', jjk3: ',confirm whether to enter the factory?', jjk4: 'Confirm', jjk5: 'System prompt', jjk6: 'Successful entry', jkk7: ',confirm whether to leave the factory?', jkk8: 'Successful empty', jKk9: 'Successful exit', lm: 'The phone number cannot be empty', lm1: 'The Id number cannot be empty',
      lm2: 'The entry time cannot be empty', lm3: 'The expected delivery/delivery weight cannot be empty', lm4: 'The reason cannot be empty', lm5: 'The lamiPak Contact cannot be empty', lm6: 'The driver entry mode is required', lm7: 'The general carrier cannot be empty', lm8: 'The reason for lose weight change cannot be empty',
      lm9: 'Modify successfully', lm10: 'Modify Vehicle Reservation', lmm: 'Pass the audit', lmm1: 'Whether to cancel weighing?', lmm2: 'Cancel one pound successfully', lmm22: 'Cancel two pound successfully', lmm222: 'Please check the reservation status', lmm3: 'Whether to obsolete weighing?', lmm4: 'Obsolete weighing successfully', lmm5: 'Add successfully', lmm6: 'Be logging in...', lmmm: 'Confirm', lmmm1: 'Are you sure to log out and exit the system?',
      lmmm2: 'Hint', lmmm3: 'The supplier cannot be empty', lmmm4: 'Can not enter the factory,reservation status: To make a card', lmmm5: 'Can not leave the factory,reservation status is not: completed', lmmm6: ',confirm whether the vehicle is empty or not?', lmmm7: 'Can not empty car, please check whether the status is approved and entered the factory',
