...
import com.vrs.common.exception.ServiceException;
...
public class ApplicationServiceImpl implements ApplicationService {
    ...
    public List<VRSSupplierApp> selectVRSSupplierList(){
        return carApplicationMapper.selectVRSSupplierList();
    }
     ...
     */
    @Override
    public boolean checkRecordExists(String vrsDnnum, String vrsDnLine) {
        return carApplicationMapper.checkRecordExists(vrsDnnum,vrsDnLine);
    }
     ...
     */
    @Override
    public int insertVRSDeliveryItemFieldThird(VRSDeliveryItemField VRSDeliveryItemField) {
        return carApplicationMapper.insertVRSDeliveryItemFieldThird(VRSDeliveryItemField);
    }
     ...
     */
    @Override
    public List<VRSDeliveryItemField> selectVRSDeliveryItemFieldInsertList(java.sql.Date yesterday) {
        return carApplicationMapper.selectVRSDeliveryItemFieldInsertList(yesterday);
    }
     ...
     */
    @Override
    public int insertVRSDeliveryItemFieldReal(VRSDeliveryItemReal VRSDeliveryItemReal) {
        return carApplicationMapper.insertVRSDeliveryItemFieldReal(VRSDeliveryItemReal);
    }
     ...
     */
    @Override
    public boolean checkSaleExists(java.sql.Date yesterday,String vrsDnnum, String vrsDnLine) {
        return carApplicationMapper.checkSaleExists(yesterday,vrsDnnum, vrsDnLine);
    }
     ...
     */
    @Override
    public boolean checkSaleExistsNoDate(String vrsDnnum, String vrsDnLine) {
        return carApplicationMapper.checkSaleExistsNoDate(vrsDnnum, vrsDnLine);
    }
     ...
     */
    @Override
    public int deleteByvrsDnnumAndvrsDnLine(String vrsDnnum, String vrsDnLine) {
        return carApplicationMapper.deleteByvrsDnnumAndvrsDnLine(vrsDnnum,vrsDnLine);
    }
     ...
     */
    @Override
    public int deleteByvrsDnnumAndvrsDnLineAndDate(java.sql.Date yesterday, String vrsDnnum, String vrsDnLine) {
        return carApplicationMapper.deleteByvrsDnnumAndvrsDnLineAndDate(yesterday, vrsDnnum, vrsDnLine);
    }
     ...
     */
    @Override
    public int updateVRSDeliveryItemFieldReal(VRSDeliveryItemReal VRSDeliveryItemReal) {
        return carApplicationMapper.updateVRSDeliveryItemFieldReal(VRSDeliveryItemReal);
    }
     ...
     */
    @Override
    public void batchDeleteByvrsDnnumAndvrsDnLineAndDate(java.sql.Date yesterday, List<String> vrsDnnums, List<String> vrsDnLines) {
        if (vrsDnnums != null && vrsDnLines != null && !vrsDnnums.isEmpty() && !vrsDnLines.isEmpty()) {
            carApplicationMapper.batchDeleteByvrsDnnumAndvrsDnLineAndDate(yesterday, vrsDnnums, vrsDnLines);
        }
    }
     ...
     */
    @Override
    public void batchDeleteByvrsDnnumAndvrsDnLineReal(List<String> vrsDnnums, List<String> vrsDnLines) {
        if (vrsDnnums != null && vrsDnLines != null && !vrsDnnums.isEmpty() && !vrsDnLines.isEmpty()) {
            carApplicationMapper.batchDeleteByvrsDnnumAndvrsDnLineReal(vrsDnnums, vrsDnLines);
        }
    }
     ...
     */
    @Override
    public void batchInsertVRSDeliveryItemFieldReal(List<VRSDeliveryItemReal> itemsToInsert) {
        if (itemsToInsert != null && !itemsToInsert.isEmpty()) {
            carApplicationMapper.batchInsertVRSDeliveryItemFieldReal(itemsToInsert);
        }
    }
     ...
     */
    @Override
    public void batchUpdateVRSDeliveryItemFieldReal(List<VRSDeliveryItemReal> itemsToUpdate) {
        if (itemsToUpdate != null && !itemsToUpdate.isEmpty()) {
            carApplicationMapper.batchUpdateVRSDeliveryItemFieldReal(itemsToUpdate);
        }
    }
     ...
     */
    @Override
    public void batchInsertVRSDeliveryItemFieldThird(List<VRSDeliveryItemField> itemsToInsert) {
        if (itemsToInsert != null && !itemsToInsert.isEmpty()) {
            carApplicationMapper.batchInsertVRSDeliveryItemFieldThird(itemsToInsert);
        }
    }
     ...
     */
    @Override
    public void batchUpdateVRSDeliveryItemFieldThird(List<VRSDeliveryItemField> itemsToUpdate) {
        if (itemsToUpdate != null && !itemsToUpdate.isEmpty()) {
            carApplicationMapper.batchUpdateVRSDeliveryItemFieldThird(itemsToUpdate);
        }
    }
     ...
     */
    @Override
    public void batchDeleteByvrsDnnumAndvrsDnLine(List<String> vrsDnnums, List<String> vrsDnLines) {
        if (vrsDnnums != null && vrsDnLines != null && !vrsDnnums.isEmpty() && !vrsDnLines.isEmpty()) {
            carApplicationMapper.batchDeleteByvrsDnnumAndvrsDnLine(vrsDnnums, vrsDnLines);
        }
    }
