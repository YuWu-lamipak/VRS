/*
 ...
 Source Server         : VRS车辆预约系统
 Source Server Type    : MySQL
 Source Server Version : 80037 (8.0.37)
 Source Host           : localhost:3306
 Source Schema         : vrs_system
...
-- ----------------------------
-- Table structure for VRS_car_application
-- ----------------------------
DROP TABLE IF EXISTS `VRS_car_application`;
CREATE TABLE `VRS_car_application`  (
  ...
  `businessType` int NULL DEFAULT NULL COMMENT '第三方业务类型0: 采购 1：销售 2：废料 3:其他',
  ...
  `cardType` int NULL DEFAULT NULL COMMENT '1=IC 卡号，2=电子标签 地磅系统传过来',
...
-- ----------------------------
-- Table structure for VRS_audit
-- ----------------------------
DROP TABLE IF EXISTS `VRS_audit`;
CREATE TABLE `VRS_audit`  (
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '审计表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for VRS_config
-- ----------------------------
DROP TABLE IF EXISTS `VRS_config`;
CREATE TABLE `VRS_config`  (
...
-- ----------------------------
-- Table structure for VRS_dept
-- ----------------------------
DROP TABLE IF EXISTS `VRS_dept`;
CREATE TABLE `VRS_dept`  (
...
-- ----------------------------
-- Table structure for VRS_dict_data
-- ----------------------------
DROP TABLE IF EXISTS `VRS_dict_data`;
CREATE TABLE `VRS_dict_data`  (
...
-- ----------------------------
-- Table structure for VRS_dict_type
-- ----------------------------
DROP TABLE IF EXISTS `VRS_dict_type`;
CREATE TABLE `VRS_dict_type`  (
...
-- ----------------------------
-- Table structure for VRS_global_variable
-- ----------------------------
DROP TABLE IF EXISTS `VRS_global_variable`;
CREATE TABLE `VRS_global_variable`  (
...
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '全局变量表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for VRS_logininfor
-- ----------------------------
DROP TABLE IF EXISTS `VRS_logininfor`;
CREATE TABLE `VRS_logininfor`  (
...
-- ----------------------------
-- Table structure for VRS_menu
-- ----------------------------
DROP TABLE IF EXISTS `VRS_menu`;
CREATE TABLE `VRS_menu`  (
...
-- ----------------------------
-- Table structure for VRS_oper_log
-- ----------------------------
DROP TABLE IF EXISTS `VRS_oper_log`;
CREATE TABLE `VRS_oper_log`  (
...
-- ----------------------------
-- Table structure for VRS_post
-- ----------------------------
DROP TABLE IF EXISTS `VRS_post`;
CREATE TABLE `VRS_post`  (
...
-- ----------------------------
-- Table structure for VRS_role
-- ----------------------------
DROP TABLE IF EXISTS `VRS_role`;
CREATE TABLE `VRS_role`  (
...
-- ----------------------------
-- Table structure for VRS_role_dept
-- ----------------------------
DROP TABLE IF EXISTS `VRS_role_dept`;
CREATE TABLE `VRS_role_dept`  (
...
-- ----------------------------
-- Table structure for VRS_role_menu
-- ----------------------------
DROP TABLE IF EXISTS `VRS_role_menu`;
CREATE TABLE `VRS_role_menu`  (
  `role_id` bigint NOT NULL COMMENT '角色ID',
...
-- ----------------------------
-- Table structure for VRS_sale_item_insert
-- ----------------------------
DROP TABLE IF EXISTS `VRS_sale_item_insert`;
CREATE TABLE `VRS_sale_item_insert`  (
  `VRS_dnnum` char(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '交货单号',
  `VRS_actualdeliverydate` date NULL DEFAULT NULL COMMENT '实际发货日期',
  `VRS_loadTime` date NULL DEFAULT NULL COMMENT '装货时间',
  `VRS_dnline` char(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '交货单行号',
  `VRS_dnlineref` char(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '交货单参考行号',
  `VRS_batch` char(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '批次',
  `VRS_grossweight` decimal(15, 2) NULL DEFAULT NULL COMMENT '行项目毛重',
  `VRS_weightunit` char(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '重量单位',
  `VRS_packagingid` char(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '包装ID (柜子)',
  `VRS_car_number` char(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '车牌号',
  `VRS_insert_time` datetime NULL DEFAULT NULL COMMENT '插入时间',
  `VRS_update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `VRS_match_flag` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '匹配标记',
  INDEX `indexdd`(`VRS_dnnum` ASC, `VRS_dnline` ASC) USING BTREE,
  INDEX `indexrr`(`VRS_loadTime` ASC) USING BTREE,
  INDEX `indexddl`(`VRS_dnnum` ASC, `VRS_dnline` ASC, `VRS_loadTime` ASC) USING BTREE,
  INDEX `indexlm`(`VRS_loadTime` ASC, `VRS_match_flag` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '销售项目插入表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for VRS_sale_item_real
-- ----------------------------
DROP TABLE IF EXISTS `VRS_sale_item_real`;
CREATE TABLE `VRS_sale_item_real`  (
  `VRS_Id` char(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '交货单Id',
  `VRS_dnnum` char(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '交货单号',
  `VRS_actualdeliverydate` date NULL DEFAULT NULL COMMENT '实际发货日期',
  `VRS_loadTime` date NULL DEFAULT NULL COMMENT '装货时间',
  `VRS_dnline` char(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '交货单行号',
  `VRS_order_id` char(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '预约号码',
  `VRS_car_number` char(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '车牌号',
  `VRS_packagingid` char(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '包装ID',
  `VRS_grossweight` decimal(15, 2) NULL DEFAULT NULL COMMENT '预约重量',
  `VRS_insert_time` datetime NULL DEFAULT NULL COMMENT '插入时间',
  `VRS_update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`VRS_Id`) USING BTREE,
  INDEX `indexxx`(`VRS_dnnum` ASC, `VRS_dnline` ASC) USING BTREE,
  INDEX `indexuu`(`VRS_loadTime` ASC) USING BTREE,
  INDEX `indexoi`(`VRS_order_id` ASC) USING BTREE,
  INDEX `indexdcp`(`VRS_dnnum` ASC, `VRS_car_number` ASC, `VRS_packagingid` ASC) USING BTREE,
  INDEX `indexddo`(`VRS_dnnum` ASC, `VRS_dnline` ASC, `VRS_order_id` ASC) USING BTREE,
  INDEX `indexog`(`VRS_order_id` ASC, `VRS_grossweight` ASC) USING BTREE,
  FULLTEXT INDEX `idx_fulltext`(`VRS_car_number`, `VRS_dnnum`, `VRS_packagingid`, `VRS_order_id`)
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '销售项目实际表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for VRS_scrap_advance
-- ----------------------------
DROP TABLE IF EXISTS `VRS_scrap_advance`;
CREATE TABLE `VRS_scrap_advance`  (
  ...
  INDEX `VRS_nd`(`oa_name` ASC, `oa_date_time` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '废料预付款表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for VRS_supplier
-- ----------------------------
DROP TABLE IF EXISTS `VRS_supplier`;
CREATE TABLE `VRS_supplier`  (
...
-- ----------------------------
-- Table structure for VRS_supplier_local
-- ----------------------------
DROP TABLE IF EXISTS `VRS_supplier_local`;
CREATE TABLE `VRS_supplier_local`  (
  `ID` varchar(125) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `updateTime` datetime NULL DEFAULT NULL,
  `insertTime` datetime NULL DEFAULT NULL
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '本地供应商表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for VRS_user
-- ----------------------------
DROP TABLE IF EXISTS `VRS_user`;
CREATE TABLE `VRS_user`  (
...
-- ----------------------------
-- Table structure for VRS_user_post
-- ----------------------------
DROP TABLE IF EXISTS `VRS_user_post`;
CREATE TABLE `VRS_user_post`  (
...
-- ----------------------------
-- Table structure for VRS_user_role
-- ----------------------------
DROP TABLE IF EXISTS `VRS_user_role`;
CREATE TABLE `VRS_user_role`  (
  `user_id` bigint NOT NULL COMMENT '用户ID',
  `role_id` bigint NOT NULL COMMENT '角色ID',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_unicode_ci COMMENT = '任务表' ROW_FORMAT = DYNAMIC;
