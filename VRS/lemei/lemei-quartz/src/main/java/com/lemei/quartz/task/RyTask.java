...
public class RyTask
{
    ...
    public void getSupplier(String str) throws SchedulerException {
        ...
        List<LmSupplier> list = JSONObject.parseArray(jsonObjectresult.toJSONString(), LmSupplier.class);
        ryTaskService.deleteLmSuppliers();
        ryTaskService.updateLmSupplier(list);
    }
