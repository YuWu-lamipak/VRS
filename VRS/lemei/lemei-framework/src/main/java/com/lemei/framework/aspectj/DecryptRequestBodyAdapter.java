package com.lemei.framework.aspectj;


import com.lemei.common.annotation.EncryptFilter;
import com.lemei.common.exception.CustomException;
import com.lemei.common.utils.StreamUtil;
import com.lemei.common.utils.StringUtils;
import com.lemei.common.utils.sign.AESUtil;
...
public class DecryptRequestBodyAdapter extends RequestBodyAdviceAdapter  {
    private Logger log = LoggerFactory.getLogger(DecryptRequestBodyAdapter.class);
    /**
    ...
    public HttpInputMessage beforeBodyRead(HttpInputMessage inputMessage, MethodParameter methodParameter, Type targetType,
        ...
        if (Strings.isNotEmpty(s)) {
            ...
            if (StringUtils.isNotEmpty(bodyDec)) {
                // 使用解密后的数据，构造新的读取流
